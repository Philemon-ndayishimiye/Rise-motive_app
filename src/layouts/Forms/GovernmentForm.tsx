  ...
  return (
    <div className="py-3">
      <h1 className="font-family-playfair text-center text-[#1E3A8A] text-[16px] font-bold py-5">
        Submit your request for e-Government services quickly and securely.
      </h1>
      ...
      <div className="py-2">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-8 pb-3">
          ...
          <Input
            ...
            options={[
              { value: "rembo", label: "REMBO Service" },
              { value: "rra", label: "RRA" },
              { value: "RDB", label: "RDB Services" },
              { value: "RURA", label: "RURA Service" },
              { value: "Mifotra", label: "MIFOTRA Service" },
            ]}
          />
        </div>
