...
type FormErrors = Partial<Record<keyof LegalFormData, string>>;

const INITIAL_FORM_STATE: LegalFormData = {
  customerName: "",
  customerEmail: "",
  customerPhone: "",
  service: "",
...
const validateForm = (data: LegalFormData): FormErrors => {
...
export default function LegalandOfficialServices() {
  ...
  const [createLegalRequest, { isLoading }] = useCreateLegalRequestMutation();

  const handleChange = (
    field: keyof LegalFormData,
